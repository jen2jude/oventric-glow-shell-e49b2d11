...
export function TradeSecurelyBanner({ onLearnMore }: { onLearnMore: () => void }) {
  return (
    <section className="mx-auto w-full max-w-[1440px] px-4 pt-10 sm:px-8 sm:pt-20">
...
export function SecuredPayments() {
  return (
    <section className="border-t border-slate-200 bg-white">
      <div className="mx-auto w-full max-w-[1440px] px-5 py-12 text-center sm:px-8 sm:py-16">
        <div className="web-eyebrow">
      ...
      <div aria-hidden={false} className="w-full bg-[#EFEDF4] py-8">
        <ul className="mx-auto flex w-full max-w-[1440px] list-none flex-wrap items-center justify-center gap-x-8 gap-y-6 px-5 sm:gap-x-14 sm:gap-y-7 sm:px-8">
