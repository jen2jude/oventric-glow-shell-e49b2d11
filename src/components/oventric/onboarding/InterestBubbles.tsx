...
const BUBBLES: Bubble[] = [
  { id: "creators", label: "Creators", size: 26, left: 2, top: 2, delay: 0, image: mockFeed },
  ...
  { id: "lifestyle", label: "Lifestyle", size: 25, left: 0, top: 52, delay: 1.8, image: mockCashback },
  ...
  { id: "academy", label: "Academy", size: 26, left: 4, top: 76, delay: 1.1, image: mockAcademy },
  { id: "community", label: "Community", size: 22, left: 36, top: 80, delay: 2.7, color: "#00c2ff", icon: Users },
  { id: "cashback", label: "Cashback", size: 25, left: 63, top: 78, delay: 0.5, image: mockBounties },
    ...
    <div className="relative w-full aspect-[1/1.15] max-w-[420px] mx-auto select-none" aria-hidden>
      {BUBBLES.map((b) => {
        ...
        return (
          ...
          >
            <div
              className="absolute inset-0 rounded-full overflow-hidden flex flex-col items-center justify-center gap-1 border border-white/10"
              style={{
                background: b.color
                  ? `radial-gradient(circle at 30% 25%, ${b.color}, ${b.color}bb 60%, ${b.color}88)`
                  : "#1E1E24",
                boxShadow: `0 14px 34px -14px ${b.color ?? "#000"}aa`,
              }}
            >
              {b.image && (
                <img
              ...
              <span
                className="relative font-semibold text-white leading-tight px-1"
